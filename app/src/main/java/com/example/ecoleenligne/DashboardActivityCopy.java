    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DashboardActivityCopy.this, ListeCoursActivity.class);
        ...
        subscription_card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(MainActivity.MODE.equals("ONLINE")) {
                    //Intent intent = new Intent(DashboardActivityCopy.this, SubscriptionListActivity.class);
                    //startActivity(intent);
                } else {
        ...
        historic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(MainActivity.MODE.equals("ONLINE")) {
                    Intent intent = new Intent(DashboardActivityCopy.this, HistoricListActivity.class);
                    startActivity(intent);
                } else {
                    Toast toast = Toast.makeText(context, Html.fromHtml("<font color='#FFFFFF'><b>"+ getString(R.string.connection_msg) +"</b></font>"), Toast.LENGTH_SHORT);
                    View view = toast.getView();
        ...
        forum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(MainActivity.MODE.equals("ONLINE")) {
                    Intent intent = new Intent(DashboardActivityCopy.this, ForumActivity.class);
                    startActivity(intent);
                } else {
                    Toast toast = Toast.makeText(context, Html.fromHtml("<font color='#FFFFFF'><b>"+ getString(R.string.connection_msg) +"</b></font>"), Toast.LENGTH_SHORT);
                    View view = toast.getView();
        ...
        profileLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DashboardActivityCopy.this, ProfileActivity.class);
                startActivity(intent);
            }
        });

        myspace.setOnClickListener(v -> {
            Intent intent = new Intent(DashboardActivityCopy.this, MySpaceActivity.class);
            startActivity(intent);
        });
