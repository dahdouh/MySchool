...
public class ListeCoursExerciceActivity extends AppCompatActivity implements Response.Listener<JSONArray>, Response.ErrorListener, NavigationView.OnNavigationItemSelectedListener  {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            lb.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(ListeCoursExerciceActivity.this, ListeExercicesActivity.class);
